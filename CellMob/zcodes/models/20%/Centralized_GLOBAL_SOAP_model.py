...
RUN_OUTPUT_DIR = OUTPUT_ROOT / "kaust_jeddah_mekkah_soap_centralized"
...
# Same centralized train/test definition as your CE baseline
TRAIN_FILES = {
    "walk": [
...
# You should tune these if needed.
...
# Optional BCE imbalance handling before SOAP fine-tuning
...
def main():
    ...
    print("\nBuilding centralized TRAIN dataset from KAUST + Jeddah + Mekkah ...")
    X_train_full, y_train_full, _ = build_dataset(TRAIN_FILES)

    print("\nBuilding centralized TEST dataset from KAUST + Jeddah + Mekkah ...")
