...
RUN_OUTPUT_DIR = LOCAL_ONLY_OUTPUT_ROOT / "jeddah_ce_baseline_weighted"
...
def main():
    ...
    print("Building JEDDAH train dataset...")
    X_train, y_train, _ = build_dataset(TRAIN_FILES)

    print("\nBuilding JEDDAH test dataset...")
    ...
    print(f"\nComputed class weights from JEDDAH training windows: {class_weights.tolist()}")
    ...
    model_path = RUN_OUTPUT_DIR / "rnn_jeddah_3class_ce_baseline_weighted.pth"
