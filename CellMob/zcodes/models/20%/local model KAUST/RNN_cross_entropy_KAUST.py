...
RUN_OUTPUT_DIR = LOCAL_ONLY_OUTPUT_ROOT / "kaust_ce_baseline_weighted"
...
def save_metrics_summary(results, loss_history, save_path: Path):
    lines = []
...
def main():
    ...
    model_path = RUN_OUTPUT_DIR / "rnn_kaust_3class_ce_baseline_weighted.pth"
    ...
    save_metrics_summary(results, loss_history, metrics_txt_path)
